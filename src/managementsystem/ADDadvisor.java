...
public class ADDadvisor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADD Advisor");

        jLabel2.setText("ADD Information for Adding Advisor");

        jLabel3.setText("Advisor Name");

        jLabel4.setText("Advisor ID");

        jLabel5.setText("Designation");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "           --Select Advisor--", "Advisor", "Co-Advisor", "Industrial Advisor" }));
